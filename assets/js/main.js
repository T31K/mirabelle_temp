(function ($) {
    ...
    const header =` <!-- Header Section Start -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="header-logo">
                        <a href="/"><img src="assets/images/logo/logo-2.png" alt="Mirabellé Logo" class=""></a>
                    </div>
                </div>
                <!-- Header Logo End -->
                ...
                <div class="col-auto mx-auto">
                    <nav class="site-main-menu site-main-menu-left menu-height-100 justify-content-center">
                        <ul>
                            <li class=""><a href="/"><span class="menu-text">Home</span></a>
                            <li class=""><a href="/#about"><span class="menu-text">About</span></a>
                            <li class=""><a href="/#courses"><span class="menu-text">Courses</span></a>
                            <li class=""><a href="/#products"><span class="menu-text">Products</span></a>
                            <li class=""><a href="/#studentworks"><span class="menu-text">Student Works</span></a>
                            <li class=""><a href="/#contact"><span class="menu-text">Contact</span></a>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-auto col">
                    <div class="header-logo">
                        <a href="/"><img src="assets/images/logo/logo-2.png" alt="Mirabellé Logo"></a>
                    </div>
                </div>
                <!-- Header Logo End -->
    ...
    <div id="offcanvas-mobile-menu" class="offcanvas offcanvas-mobile-menu">
        <div class="inner customScroll">
            <img src="assets/images/logo/logo.png" alt="Mirabelle Logo" class="w-80 mb-2">
            <div class="offcanvas-menu">
                <ul>
                    <li><a href="/"><span class="menu-text">Home</span></a>
                    <li><a href="/#abut"><span class="menu-text">About</span></a>
                    <li><a href="/#courses"><span class="menu-text">Courses</span></a>
                    <li><a href="/#products"><span class="menu-text">Products</span></a>
                    <li><a href="/#studentworks"><span class="menu-text">Student Works</span></a>
                    <li><a href="/#contact"><span class="menu-text">Contact</span></a>
                    
                </ul>
            </div>
            <div class="offcanvas-social mt-5">
                <a href="https://facebook.com/mirabelledecoupage"><i class="fab fa-facebook-f"></i></a>
                <a href="https://www.instagram.com/mirabelledecoupage"><i class="fab fa-instagram"></i></a>
                <a href="https://www.youtube.com/channel/UCLCFZXU7ZFlATYcTCn9Bt8A"><i class="fab fa-youtube"></i></a>
                <a href="https://wa.me/60122328081"><i class="fab fa-whatsapp"></i></a>
            </div>
        </div>
    </div>`
    ...
    const footer = `<div class="footer2-section section section-padding">
                        <div class="container">
                            <div class="row Mirabellé-mb-n40">

                                <div class="col d-block mx-auto Mirabellé-mb-40">
                                    <div class="widget-about">
                                        <img src="assets/images/logo/logo.png" alt="" class="w-40 d-block mx-auto">
                                    </div>
                                </div>

                                <div class="col-lg-4 Mirabellé-mb-40">
                                    <div class="row">
                                        <div class="col">
                                            <ul class="widget-list">
                                                ...
                                                <li><a href="/#studentworks">Student Works</a></li>
                                        ...
                                        <div class="col">
                                            <ul class="widget-list">
                                                ...
                                                <li><a href="#">Sospeso Trasparenete</a></li>
                                    ...
                                    <div class="col-lg-2 Mirabellé-mb-40">
                                        <ul class="widget-list">
                                            <li> <i class="fab fa-facebook-f"></i> <a href="https://facebook.com/mirabelledecoupage">Facebook</a></li>
                                            <li> <i class="fab fa-instagram"></i> <a href="https://www.instagram.com/mirabelledecoupage">Instagram</a></li>
                                            <li> <i class="fab fa-youtube"></i> <a href="https://www.youtube.com/channel/UCLCFZXU7ZFlATYcTCn9Bt8A">Youtube</a></li>
                                            <li> <i class="fab fa-whatsapp"></i> <a href="https://wa.me/60122328081">Whatsapp</a></li>
                                        </ul>
                                    </div>
    ...
    const othercourses = `  <div class="section section-padding"  class="border-top">
                                <div class="section section-fluid section-padding pt-0">
                                    <div class="container pl-4 pr-4">

                                        <div class="section-title text-center">
                                            <h3 class=" title-icon-both"></h3>
                                            <h3 class=" title-icon-both">Other Courses</3>
                                        ...
                                        <div class="category-banner1-carousel">
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/todo-teacher" class="image"><img src="assets/images/banner/category/banner-s1-1.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/todo-teacher">TO-DO Teacher Certificate in Decoupage</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/todo-merit" class="image"><img src="assets/images/banner/category/banner-s1-2.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/todo-merit">TO-DO Certificate of Merit in Decoupage </a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/sospeso-trasparente" class="image"><img src="assets/images/banner/category/banner-s1-3.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/sospeso-trasparente">Sospeso Trasparente</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/todo-bambini" class="image"><img src="assets/images/banner/category/banner-s1-3.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/todo-bambini">TO-DO Creative Ideas Bambini Teacher's Course</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/decofoam-decoupage" class="image"><img src="assets/images/banner/category/banner-s1-3.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/decofoam-decoupage">Decofoam Decoupage Certificate of Completion</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/hobby-classes" class="image"><img src="assets/images/banner/category/banner-s1-3.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/hobby-classes">Hobby Classes</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="category-banner1">
                                                    <div class="inner">
                                                        <a href="/mixed-media" class="image"><img src="assets/images/banner/category/banner-s1-3.jpg" alt=""></a>
                                                        <div class="content">
                                                            <h3 class="title">
                                                                <a href="/mixed-media">Mixed Media Decoupage Certificate of Completion</a>
                                                            </h3>
                                                        </div>
                                                    </div>
                                                </div>
